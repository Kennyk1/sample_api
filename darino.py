...
def get_user_id_from_token(auth_header):
    ...
    try:
        ...
        decoded = jwt.decode(token, options={"verify_signature": False})  # Optionally verify signature with Supabase secret
        return decoded.get("sub")  # Supabase stores user_id in 'sub'
